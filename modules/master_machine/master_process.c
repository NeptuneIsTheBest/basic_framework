...
void RefreeSetAltitude(float current_HP, float stage_remain_time, float game_progress, float enemy_sentry_HP,
    ...
    send_data.current_base_hp = current_base_HP;
    send_data.current_enemy_base_hp = enemy_base_HP;
    send_data.current_enemy_sentry_hp = enemy_sentry_HP;
    send_data.current_shield_hp = shield_HP;
}
