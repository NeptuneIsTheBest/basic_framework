...
// 云台参数
#define YAW_CHASSIS_ALIGN_ECD 2730  // 云台和底盘对齐指向相同方向时的电机编码器值,若对云台有机械改动需要修改
...
// 机器人底盘修改的参数,单位为mm(毫米)
#define WHEEL_BASE 209              // 纵向轴距(前进后退方向)
#define TRACK_WIDTH 209             // 横向轮距(左右平移方向)
#define CENTER_GIMBAL_OFFSET_X 0    // 云台旋转中心距底盘几何中心的距离,前后方向,云台位于正中心时默认设为0
#define CENTER_GIMBAL_OFFSET_Y 0    // 云台旋转中心距底盘几何中心的距离,左右方向,云台位于正中心时默认设为0
#define RADIUS_WHEEL 76             // 轮子半径
#define REDUCTION_RATIO_WHEEL 19.0f // 电机减速比,因为编码器量测的是转子的速度而不是输出轴的速度故需进行转换

#define CHASSIS_TYPE_OMNI // 全向轮底盘
// #define CHASSIS_TYPE_MECANUM // 麦轮底盘
...
#if defined(CHASSIS_TYPE_OMNI) && defined(CHASSIS_TYPE_MECANUM)
